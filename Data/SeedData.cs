...
public static class SeedData
{
    public static void Seed(ApplicationDbContext context)
    {
        ...
        try
        {
            ...
            context.Usuarios.AddRange(diego, ana, luis);
            context.SaveChanges();
            Console.WriteLine($"[SEED] 1. Usuarios creados: 3 (IDs {diego.Id}, {ana.Id}, {luis.Id})");
            ...
            context.SaveChanges();
            Console.WriteLine("[SEED] 3. Miembros creados: 7");
            ...
            context.Adjuntos.AddRange(
                new Adjunto { TareaId = t3.Id, NombreArchivo = "propuesta-hero.pdf", RutaRelativa = "/uploads/propuesta-hero.pdf", TamanoBytes = 1248576, FechaSubida = now.AddDays(-2) },
                new Adjunto { TareaId = t3.Id, NombreArchivo = "paleta-colores.png", RutaRelativa = "/uploads/paleta-colores.png", TamanoBytes = 348160, FechaSubida = now.AddDays(-2) }
            );
            context.SaveChanges();
